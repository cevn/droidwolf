...
import com.cevn.droidwolf.MainActivity;

/**
 * Created by sameer on 11/3/13.
 */

public class DroidwolfAuthenticator extends AbstractAccountAuthenticator {
    private final Context mContext;
    private final String TAG = "DroidwolfAuthenticator.java";

    public DroidwolfAuthenticator(Context context) {
        super(context);
        mContext = context;
    }

    public Bundle addAccount(AccountAuthenticatorResponse response, String accountType, String authTokenType, String[] requiredFeatures, Bundle options) throws NetworkErrorException {
        Log.d("droidwolf", TAG + "> addAccount");
    ...
    public Bundle getAuthToken(AccountAuthenticatorResponse response, Account account, String authTokenType, Bundle options) throws NetworkErrorException {
        ...
        Log.d("droidwolf", TAG + "> peekAuthToken returned - " + authToken);
        ...
        if (TextUtils.isEmpty(authToken)) {
            ...
            if (password != null) {
                try {
                    Log.d("droidwolf", TAG + "> re-authenticating with the existing password");
